<template>
    <div>        
        <!-- section Start -->
        <section class="vh-100 d-flex align-items-center" style="background: url('contact-detail.jpg') center center">
...
const cityName = ref("");
const openWeatherApiKey = process.env.VUE_APP_WEATHER_API_KEY; 
